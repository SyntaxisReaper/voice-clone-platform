...
const SignInCanvasLogin = dynamic(() => import('../components/SignInCanvasLogin'), { ssr: false })
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <button onClick={() => setShowLogin(true)} className="btn-secondary text-lg px-8 py-4 rounded-xl inline-flex items-center space-x-2">
      ...
      <SignInCanvasLogin open={showLogin} onClose={() => setShowLogin(false)} />
    </div>
  )
}
